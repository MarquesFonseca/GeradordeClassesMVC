/*
Deployment script for BancoTeste
...
GO
:setvar DatabaseName "BancoTeste"
:setvar DefaultFilePrefix "BancoTeste"
...
GO
PRINT N'Rename refactoring operation with key  is skipped, element [dbo].[Table].[Id] (SqlSimpleColumn) will not be renamed to Código';
...
BEGIN TRANSACTION
GO
PRINT N'Creating [dbo].[TabelaTeste]...';
